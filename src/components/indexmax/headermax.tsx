         ...
         className="Header-img">
          ...
          >
            ...
            >
              <Row className="g-2">
                <Col md>
                  <img src="../src/assets/images/img_1.jpg" style={{
                width: "250px",
                height: "auto"}} />
                </Col>
                <Col md>
                  ...
                  <h6 className='my-text' >Aprende desde 0 framework's y domina y mundo de posibilidades en la web🌐.</h6>
                  <h6 className='my-text' >Avanzado - abr 28, 2021</h6>
                  <DiReact/><SiJavascript/>
                </Col>
              </Row>
            </div>
            <div
              className="my-text-block-1"
            >
              <Row className="g-2">
                <Row>
                <Col md>
                <img src="../src/assets/images/img_2.jpg" style={{
                width: "80px",
                height: "auto",
              margin: "5px" }} />
                ...
                <Row>
                <Col md>
                <img src="../src/assets/images/img_3.jpg" style={{
                width: "80px",
                height: "auto",
                margin: "5px" }} />
                </Col>
                ...
                <Row>
                <Col md>
                <img src="../src/assets/images/img_4.jpg" style={{
                width: "80px",
                height: "auto",
                margin: "5px" }} />
                </Col>
                ...
                <h6 className='my-text'>ILUSTRATOR</h6>
                  <h6 className='my-text'>Aprende a crear tus propias imagenes con Ilustrator🌄!</h6>
                </Col>
                </Row>
              </Row>
            </div>
