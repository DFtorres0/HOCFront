...
const Aboutmax = () => {
  return (
    <div>
      ...
      <div>
        <div className="row mb-5 align-items-center" style={{ marginTop: '8%'}}>
          <div className="col-lg-6 mb-4 mb-lg-0" style={{ margin: '20px auto', maxWidth: '400px' }} >
            <form action="#" className="d-flex search-form">
              ...
              <input
                ...
                value="Buscar!" style={{ marginLeft: '10px', width: '1o0px' }}
              />
            </form>
          </div>
      ...
      <Container className='p-4'>
        <Row>
          <Col lg='6' md='12' className='mb-4 mb-md-0'>
            ...
            <p>
            Si quieres estar enterado de nuestras ultimas tutorias, clases, practicas proyectos siguenos:😎
            </p>
          </Col>
